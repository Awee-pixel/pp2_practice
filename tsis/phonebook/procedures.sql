-- procedures.sql
-- New stored procedures and functions for TSIS 1.
-- Run after schema.sql.

-- ─────────────────────────────────────────────────────────────────────────────
-- 1.  add_phone(contact_name, phone, type)
--     Adds a phone number to an existing contact.
--     p_contact_name matches first_name (case-insensitive).
-- ─────────────────────────────────────────────────────────────────────────────
...
DECLARE
    v_contact_id INT;
BEGIN
    -- Find contact (first match by first_name, case-insensitive)
...
--     Full-text search across: first_name, last_name, email, and ALL phones.
--     Returns distinct contacts with their group name.
-- ─────────────────────────────────────────────────────────────────────────────
